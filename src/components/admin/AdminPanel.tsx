...
import {
  ...
  Search, Users, Megaphone, Settings, BarChart3, Ban, UserCheck,
  Save, Loader2, Eye, Wrench,
} from 'lucide-react';
import {
  batchDeleteExpiredReports, fetchReports, deleteReport,
...
function PinsTab() {
  const { reports, setReports, removeReportFromCache } = useAppStore();
